// Aula final contendo quase todos tipos de decorator
...
const pessoa = new UmaPessoa('Claudemagno', 'Vargas Gomes', 52);
pessoa.nomeCompleto = 'Magno V Gomes';
const metodo = pessoa.metodo('Deus é fiel!!');
const metodoEstatico = UmaPessoa.metodoEstatico('Deus é fiel!!');
console.log(pessoa);
console.log(metodo);
